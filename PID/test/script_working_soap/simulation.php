...
function simulation($psEHealthID,$code_prestataire,$codeMedical,$lieuPrestation,$varMatricule,$NombreActeMedical)
{
	...
	$OPC = ConnexionBdd('localhost','doctipro_v6','doctipro_v6_user',']FQZhyM)3A[w2k86');
...
$TimeStampCanonized = CanoniseTT($expires,$created,"TimeStimeCanonizedFromScrath.xml");
...
file_put_contents('RequestGuichet.xml', $doc->saveXML());
...
file_put_contents('responseGuichet.xml', $response);
...
$a = str_replace('
      <saml:Assertion/>
    ',$assertionText2,$a);
file_put_contents('Request.xml',$a);
...
file_put_contents('respondeCNS.xml', $response);
...
file_put_contents('RequestBusiness.xml',$a);
...
file_put_contents('responseCNSBusinessCall.xml', $response);
